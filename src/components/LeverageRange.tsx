const LeverageRange = ({
  ...
  return (
    <form className="flex flex-col w-full lg:w-[267px] gap-[12px] p-[20px] pb-[80px] lg:pb-[20px] rounded-[16px] rounded-b-none lg:rounded-b-[16px] border-[1px] border-white border-opacity-[14%] backdrop-blur-3xl lg:backdrop-blur-lg bg-white bg-opacity-[10%] lg:bg-opacity-[4%]">
