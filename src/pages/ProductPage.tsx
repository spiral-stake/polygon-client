...
const ProductPage = ({ flashLeverage }: { flashLeverage: FlashLeverage }) => {
  ...
  useEffect(() => {
    ...
    const updateActionBtn = () => {
      ...
      const liquidityAssets = new BigNumber(
      ...
      const maxLeverageAmount = BigNumber.max(
        new BigNumber(0),
        liquidityAssets.dividedBy(leverageValue.minus(1)).minus(10)
      );

      console.log(maxLeverageAmount.toString());
      ...
      //     text: "Leverage",
      //     disabled: false,
      //     warning: "You should deposit more than > $5,000 for better returns",
      //     error: "",
      //   }));
      // }
          ...
          <div className="flex flex-col gap-[16px]">
            ...
            <div className="">
              <ProductTitle
                ...
                subheading={`Deposit and automatically create a leveraged looping position with ${collateralToken.symbol} for maximized returns on your idle holdings.`}
 ...
 grid-rows-1 gap-[13px] items-center"
          ...
          <div className="w-full flex flex-col gap-[16px] lg:hidden">
            <PoolInfo fromToken={fromToken} collateralToken={collateralToken} leverage={leverage} />
            <div className="bg-white flex flex-col lg:hidden w-full h-fit items-center gap-[24px] bg-opacity-[2%] rounded-xl p-[20px] lg:p-[32px]">
              ...
              <div className="flex flex-col w-full gap-[8px] text-[14px] lg:text-[16px] font-[400] text-[#8E8E8E]">
                <div className="flex justify-between items-center">
                  <p>Current price</p>
                  <p>{Number(collateralToken.valueInLoanToken).toFixed(4)} {collateralToken.loanToken.symbol}/{collateralToken.symbol}</p>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <p>
                    ...
                    ).toFixed(4)} {collateralToken.loanToken.symbol}/{collateralToken.symbol}
                  </p>
                </div>
                {/* <div className="flex justify-between items-center">
